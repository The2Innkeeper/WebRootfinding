 ...
 */
export function mapIntervalToPositiveReals(polynomial, interval) {
 ...
 */
export function mapUnitIntervalToPositiveReals(polynomial) {
    const transformedCoefficients = [...polynomial];
 ...
 */
export function transformedForLowerInterval(polynomial, scale) {
    const transformedCoefficients = [...polynomial];
    // Step 1: Apply x := sx
 ...
 */
export function taylorShiftBy1(polynomial) {
 ...
 * @returns The shifted polynomial coefficients.
 */
export function taylorShift(polynomial, shift) {
    const newCoefficients = [...polynomial];
    for (let i = 1; i < newCoefficients.length; i++) {
        for (let k = 0; k < i; k++) {
 ...
 */
export function reversed(polynomial) {
 ...
 */
export function scaleInput(polynomial, scaleFactor) {
 ...
 * @returns A new polynomial with scaled coefficients.
 */
export function scaleInputInReverseOrder(polynomial, scaleFactor) {
